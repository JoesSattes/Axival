...
public class ArchiveAnimation extends ApplicationAdapter implements InputProcessor{
    SpriteBatch batch;
    ...
    public void create(){
        ...
        textureAtlas = new TextureAtlas(Gdx.files.internal("spritesheet/jetSprite.atlas"));
